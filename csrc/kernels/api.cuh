...
void notify_dispatch(const int* num_tokens_per_rank, int* moe_recv_counter_mapped, int num_ranks,
                     ...
                     void** buffer_ptrs, int **task_fifo_ptrs, int rank,
                     cudaStream_t stream, int num_sms, int head = 0);

void cached_notify_dispatch(const int* rank_prefix_matrix, int num_memset_int,
                            void** buffer_ptrs, int **task_fifo_ptrs, int rank, int num_ranks,
...
void cached_notify_combine(void** buffer_ptrs, int* send_head, int num_channels, int num_recv_tokens, int num_memset_int,
                           int** task_fifo_ptrs, int rank, int num_ranks, cudaStream_t stream, int head = 0);
